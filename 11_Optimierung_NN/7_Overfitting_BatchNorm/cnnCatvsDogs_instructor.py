...
def build_model(img_shape: Tuple[int, int, int], num_classes: int, dr_rate: float) -> Sequential:
    ...
    catdog_model.add(Dropout(dr_rate))
...
if __name__ == "__main__":
    ...
    dr_rates = [0.0, 0.2, 0.3, 0.4, 0.5]

    for rate in dr_rates:
        model_name = f"catvsdog_4block_BN_dr_{rate}"
