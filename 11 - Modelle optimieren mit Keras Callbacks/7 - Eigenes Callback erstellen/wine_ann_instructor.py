...
from CustomAccuracy import PriceDifference
...
def train():
    ...
    price_diff = PriceDifference(bow_test_description, x_test_variety, x_test_embed, y_test_price)
